...
{
    /// <inheritdoc />
    public partial class InitialModelSyncWithDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MusicEvents_AspNetUsers_CreatedByUserID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PreferenceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PreferredGenres = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    EmailReminderEnabled = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PricingTiers_MusicEvents_EventID",
                        column: x => x.EventID,
                        principalTable: "MusicEvents",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RequiredFields", x => x.FieldID);
                    table.ForeignKey(
                        name: "FK_RequiredFields_MusicEvents_EventID",
                        column: x => x.EventID,
                        principalTable: "MusicEvents",
                        principalColumn: "EventID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventRegistrations_MusicEvents_EventID",
                        column: x => x.EventID,
                        principalTable: "MusicEvents",
                        principalColumn: "EventID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventRegistrations_PricingTiers_PricingTierID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrationData", x => x.DataID);
                    table.ForeignKey(
                        name: "FK_RegistrationData_EventRegistrations_RegistrationID",
                        column: x => x.RegistrationID,
                        principalTable: "EventRegistrations",
                        principalColumn: "RegistrationID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RegistrationData_RequiredFields_FieldID",
                        column: x => x.FieldID,
                        principalTable: "RequiredFields",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventRegistrations_PricingTierID",
                table: "EventRegistrations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MusicEvents_CreatedByUserID",
                table: "MusicEvents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrationData_FieldID",
                table: "RegistrationData",
                column: "FieldID");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrationData_RegistrationID",
                table: "RegistrationData",
                column: "RegistrationID");

            migrationBuilder.CreateIndex(
                name: "IX_RequiredFields_EventID",
